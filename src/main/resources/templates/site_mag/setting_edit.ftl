...
<form method="post" action="/Verwalter/setting/save" id="form1">
    ...
    <div class="tab-content" style="display: block;">
        ...
        <dl>
            <dt>经度</dt>
            <dd>
              <input name="longitude" type="text" value="<#if setting?? && setting.longitude??>${setting.longitude?string("#.######")}</#if>" class="input normal" datatype="/^(([1-9]{1}\d*)|([0]{1}))(\.(\d){1,6})?$/" errormsg="" sucmsg=" ">
          ...
          <dl>
            <dt>纬度</dt>
            <dd>
              <input name="latitude" type="text" value="<#if setting?? && setting.latitude??>${setting.latitude?string("#.######")}</#if>" class="input normal" datatype="/^(([1-9]{1}\d*)|([0]{1}))(\.(\d){1,6})?$/" errormsg="" sucmsg=" ">
              <a href="http://api.map.baidu.com/lbsapi/getpoint/" target="_blank">坐标拾取(点击获取坐标)</a>
              <span class="Validform_checktip"></span>
            </dd>
          </dl>
        ...
        <dl>
            <dt>传真号码</dt>
            <dd>
                <input name="fax" type="text" value="<#if setting??>${setting.fax!""}</#if>" class="input normal"  sucmsg=" ">
                <span class="Validform_checktip"></span>
            </dd>
        </dl>
        <dl>
