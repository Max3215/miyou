...
<!--/导航栏-->
    ...
    <div class="tab-content" style="display: none;">
        ...
        <dl>
            <dt>商品副标题</dt>
            <dd>
                <input name="subTitle" type="text" value="<#if goods??>${goods.subTitle!""}</#if>" class="input normal" sucmsg=" ">
        ...
        <dl>
            <dt>商品批次</dt>
            <dd>
                <input name="code" type="text" value="<#if goods??>${goods.code!""}</#if>" class="input normal" datatype="*6-24" sucmsg=" ">
