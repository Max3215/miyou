            ...
            <div class="l-list">
                ...
                <div class="menu-list">
                    <div class="rule-single-select">
                        <select name="typeId" onchange="javascript:setTimeout(__doPostBack('typeId',''), 0)">
                             <option value="" <#if !typeId?? || typeId==0>selected="selected"</#if>>所有订单</option>
                             <option value="1" <#if typeId?? && typeId==1>selected="selected"</#if>>订水订单</option>
                             <option value="2" <#if typeId?? && typeId==2>selected="selected"</#if>>售卡订单</option>
                        </select>
                    </div>
                </div>
                <ul class="icon-list">
                ...
                <div class="menu-list">
                    <div class="rule-single-select" >
                        ...
                        <input name="onSaleTime" type="text" value="" class="input date" onfocus="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss',lang:'zh-cn'})">
                    </div>
                 </div>
                        -->
            </div>
    ...
    <#if order_page??>
        <#list order_page.content as order>
            <tr>
                ...
                <td align="center" width="10%"><font color="#C30000">${order.totalNumber!'0'}</font></td>
