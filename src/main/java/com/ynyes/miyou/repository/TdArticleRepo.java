		...
		JpaSpecificationExecutor<TdArticle> 
{
    ...
    Page<TdArticle> findByMenuIdAndStatusIdOrderBySortIdAsc(Long menuId, Long statusId, Pageable page);
    ...
    TdArticle findTopByTitleContaining(String title);
    
    TdArticle findTopByMenuId(Long mid);
