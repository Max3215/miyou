...
import com.ynyes.miyou.repository.TdArticleCategoryRepo;
...
public class TdArticleCategoryService {
    ...
    public TdArticleCategory findByMenuIdAndTitle(Long menuId,String title){
    	return repository.findByMenuIdAndTitleContaining(menuId, title);
    }
